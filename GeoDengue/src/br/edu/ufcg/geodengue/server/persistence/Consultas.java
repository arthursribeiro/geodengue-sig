...
public class Consultas {
	...
	public static final String DADOS_FOCO = "SELECT p.descricao AS desc, p.id AS id FROM Ponto p WHERE p.tipo = 'F' AND Contains(Buffer(GeometryFromText(?, 4326), 0.001), p.geom)";
